    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          {/* AÇÕES DIREITA */}
          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 px-5 py-2.5 text-sm font-bold rounded-full border border-slate-200 btn-brand-yellow-effect transition-all">
            ...
            <button
              ...
              onClick={() => window.open('http://wa.me/5519987086791', '_blank')}
            >
          ...
          {isOpen && (
            ...
            >
              ...
              <motion.button
                ...
                className="cursor-pointer flex items-center gap-2 px-6 py-2.5 text-sm font-bold rounded-full btn-whatsapp-effect"
                onClick={() => window.open('http://wa.me/5519987086791', '_blank')}
              >
              ...
              {LINKS.slice().reverse().map((link) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`
                    px-5 py-2.5 rounded-full font-medium shadow-md border
