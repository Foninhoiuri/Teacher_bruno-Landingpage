        ...
        >
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <button
                        onClick={toggleLang}
                        className="hidden lg:flex items-center gap-2 pl-1 pr-3 py-1 bg-white border border-slate-200 rounded-full hover:bg-slate-50 transition-all shadow-sm"
                        title="Mudar Idioma"
                    >
                ...
                <div className="hidden lg:flex items-center gap-3">
                    ...
                    {/* Botão Área do Aluno */}
                    <button className="flex items-center gap-2 px-5 py-2.5 text-sm font-bold text-slate-700 bg-white border border-slate-200 rounded-full group hover-card-effect">
                        <UserCircle className="w-4 h-4 text-slate-400 group-hover:text-slate-900 transition-colors" />
                        Área do Aluno
                    </button>

                    {/* Botão WhatsApp (Pelado / Sem Efeitos) */}
                    <button className="flex items-center gap-2 px-6 py-2.5 text-sm font-bold text-slate-700 rounded-full">
